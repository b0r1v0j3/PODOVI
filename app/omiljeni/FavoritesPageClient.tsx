                                ...
                                <Link href={`/proizvodi/${product.slug}`}>
                                    <div className="relative h-48 bg-gray-100 overflow-hidden rounded-t-xl">
                                        {img && img.url.startsWith('/') ? (
                                            <Image src={img.url} alt={product.name} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="(max-width: 768px) 100vw, 25vw" />
                                        ) : (
