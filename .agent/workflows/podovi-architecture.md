...
| `ProductCharacteristics` | `product.specs` (filtered); welding-related values can link to `/proizvodi/welding-rod/[ref]` via `welding-helpers.ts` | `components/ProductCharacteristics.tsx` |
