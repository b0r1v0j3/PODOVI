      ...
      <div className="relative aspect-[4/3] bg-[#F5F5F7] overflow-hidden">
        {primaryImage ? (
          <Image
            ...
            quality={90}
            className={`transition-transform duration-500 ${product.categoryId === '5' ? 'object-cover object-left group-hover:scale-[1.03]' :
                product.slug === 'gerflor-mipolam-technic-el5-eu' ? 'object-cover object-bottom scale-[1.15] origin-bottom group-hover:scale-[1.2]' : 'object-cover group-hover:scale-[1.03]'
              }`}
